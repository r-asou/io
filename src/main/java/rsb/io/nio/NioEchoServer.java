	...
	public static void main(String[] args) throws Exception {
		...
		while (true) {
			...
			while (keyIterator.hasNext()) {
				 ...
				 * //https://stackoverflow.com/questions/5906444/socketchannel-write-
				 * writing-problem#5943113 // we only get to this branch if the write()
				 * returns 0 var client = (SocketChannel) key.channel(); var toWrite =
				 * (ByteBuffer) key.attachment(); toWrite.flip(); attemptWrite(client,
				 * selector, toWrite); }
				 */
				keyIterator.remove();
			}
